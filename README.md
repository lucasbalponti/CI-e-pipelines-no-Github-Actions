...
| [Dockerfile](https://github.com/lucasbalponti/CI-e-pipelines-no-Github-Actions/blob/main/Dockerfile) | Dockerfile para a criação da imagem |
| [Script docker compose](https://github.com/lucasbalponti/CI-e-pipelines-no-Github-Actions/blob/main/docker-compose.yml) | Arquivo onde são feitas as configurações do docker do banco de dados  |
